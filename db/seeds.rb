...
Job.create(title: "Bicycle Tour Guide", company: "Escapes", salary: 54000)
...
Article.create(title:"The 2021 Sweat Science Holiday Book List", author:"Asher 'buzzsaw' Bay", body:"All I want for Christmas is a big snowstorm accompanied by a massive multi-day Internet outage that makes curling up on the sofa with a book the only reasonable option. Here are some titles you might want to stock up on, in case you’re lucky enough to receive that meteorological gift. It’s a mixed list, mostly but not always related to the Sweat Science themes of science, endurance, and health, and mostly but not always published this year.",)
